...
public class Wait3LvsNoStuckWithFailureController {
  private final Wait3LvsNoStuckLv01WithFailureAsync wait3LvsNoStuckLv01WithFailureAsync;
  private static final String REQUEST_PATH = "/custom-async/spawn-children/wait-3lvs-no-stuck-with-failure";
  ...
  public String asyncSpawnChildren(
    ...
    Future<String> future = wait3LvsNoStuckLv01WithFailureAsync.spawnChildren(lv02Count, lv03Count, lv03sleep);
    future.get();
    return "finished";
  }
}
